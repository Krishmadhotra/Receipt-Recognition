...
def main(text_dir, eps=0.3, min_samples=2):
    ...
    # Print differences between texts with similarity score above 0.8
    clusters = {}
...
if __name__ == "__main__":
    text_dir = '/Users/I748970/Downloads/TEXTFILES2'  # Directory containing text files for clustering
    main(text_dir)
